...
const ProductDetails = ({ product, products }) => {
    ...
    const { decQty, incQty, qty, onAdd, setShowCart } = useStateContext(); // using this as a hook to fetch the functionality mentioned for the folllowing in useStateContext
